...
function Nav() {
    ...
    const handleHamburgerClick = () => {
        ...
        if (mobileNavItems.classList.contains("hide")) {
            mobileNavItems.classList.remove("hide");
            ...
            mobileNavItems.classList.add("hide");
        }
    };
    ...
    return (
        <>
            <div className="text-text dark:text-dark-text bg-background dark:bg-dark-background shadow-xl w-full flex justify-center p-2 relative z-50">
                <div className="h-12 flex justify-between w-full max-w-7xl ">
                    <div className="flex flex-row items-center justify-start gap-3 w-[60%] max-sm:w-full">
                        <div className="w-48" onClick={handleLogoClick}>
                    ...
                    <div className="flex flex-shrink-0 justify-end items-center gap-5">
                        {/* theme toogle icon */}
                        <div name="theme-toogle" className="dark:fill-dark-text fill-text max-sm:hidden">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                height="25"
                                onClick={toogleTheme}
                        ...
                        {/* Message icon */}
                        <div name="message icon" className="dark:fill-dark-text fill-text max-sm:hidden">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                height="25"
                                viewBox="0 -960 960 960"
                        ...
                        {/* Notification icone */}
                        <div naem=" notification-icon" className="dark:fill-dark-text fill-text max-sm:hidden">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                height="25"
                                viewBox="0 -960 960 960"
                        ...
                        {/* Query icon */}
                        <div name="query" className="dark:fill-dark-text fill-text max-sm:hidden">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                height="25"
                                viewBox="0 -960 960 960"
                        ...
                        <div
                            id="hamburger"
                            className="flex-col gap-2 max-sm:flex items-center justify-center hidden w-6 h-6"
                            onClick={handleHamburgerClick}
                        >
                            <div id="div1" className="border border-solid border-gray-500 w-full "></div>
                            <div id="div2" className="border border-solid border-gray-500 w-full "></div>
                            <div id="div3" className="border border-solid border-gray-500 w-full "></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* mobile nave links */}
            <div
                id="mobile-nave-links"
                className={`w-full h-fit p-2 flex flex-col gap-3 rounded-sm shadow-2xl hide text-text dark:text-dark-text bg-background dark:bg-dark-background`}
            >
                <div
                    className="dark:fill-dark-text fill-text flex gap-1 link-hover w-fit"
                    onClick={toogleTheme}
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
