            ...
            <div className="flex items-center justify-center h-full bg-[#ffff] max-w-[100rem] w-full">
                <div className="grid grid-cols-2 h-screen w-full max-sm:grid-cols-1">
                    ...
                    <div className="shadow-md px-8 py-10 w-full flex flex-col items-center justify-center relative bg-[#ffff]">
                        <h1 className="text-center text-2xl mb-10 text-[#110f3e] font-semibold tracking-wide">Sign up</h1>
                        <form className="grid grid-cols-2 gap-x-4" onSubmit={handleSubmit}>
                            <div className=" col-span-2 w-full flex flex-col items-center justify-center mb-8">
                                <label htmlFor="profile-picture" className="mb-4 w-24 aspect-square overflow-hidden rounded-full">
                                    <img src={values.picture ? URL.createObjectURL(values.picture) : profileImageHolder}
                                        alt="profile-image"
                                        className="w-full shadow-xl object-fill"
                                    />
                                </label>
                                <input type="file" name="picture" id="profile-picture" hidden onChange={(e) => { setFieldValue("picture", e.target.files[0]) }} onBlur={handleBlur} />
                                {/* <Field type="file" name="picture" id='profile-picture' accept="image/*" /> */}
                                <p className="text-red-500 text-sm">{errors.picture && touched.picture && errors.picture}</p>
                            </div>
                            <div className="mb-8">
                                <input
                                    type="text"
                                    ...
                                    onBlur={handleBlur}
                                />
                                <p className="text-red-500 text-sm">{errors.firstName && touched.firstName && errors.firstName}</p>
                            </div>
                            <div className="mb-8">
                                <input
                                    type="text"
                                    ...
                                    onBlur={handleBlur}
                                />
                                <p className="text-red-500 text-sm">{errors.lastName && touched.lastName && errors.lastName}</p>
                            </div>
                            <div className="mb-8">
                                <input
                                    type="text"
                                    ...
                                    onBlur={handleBlur}
                                />
                                <p className="text-red-500 text-sm">{errors.email && touched.email && errors.email}</p>
                            </div>
                            <div className="mb-8">
                                <input
                                    type="password"
                                    ...
                                    onBlur={handleBlur}
                                />
                                <p className="text-red-500 text-sm">{errors.password && touched.password && errors.password}</p>
                            </div>
                            <div className="mb-8">
                                <input
                                    type="text"
                                    ...
                                    onBlur={handleBlur}
                                />
                                <p className="text-red-500 text-sm">{errors.occupation && touched.occupation && errors.occupation}</p>
                            </div>
                            <div className="mb-8">
                                <input
                                    type="text"
                                    ...
                                    onBlur={handleBlur}
                                />
                                <p className="text-red-500 text-sm">{errors.location && touched.location && errors.location}</p>
                            </div>
                        ...
                        <div className="mt-6 text-center text-gray-600">
                            Don't have an account? <Link to="/" className="text-blue-500">Log in </Link>
                        </div>
