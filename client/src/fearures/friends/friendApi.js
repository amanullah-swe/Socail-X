...
export const addRemoveFreindsAsync = createAsyncThunk(
  "friend/addRemoveFreindsAsync",
  async ({ userId, personId, token }, thunkAPI) => {
    try {
      const response = await axios(
        `${baseApiUrl}/users/${userId}/${personId}`,
        {
          method: "patch",
          headers: {
