  ...
  return (
    <div className=" w-full flex flex-col gap-3 text-text dark:text-dark-text bg-background dark:bg-dark-background shadow-xl h-fit pb-4 p-3 rounded-xl">
      ...
      <div className="flex flex-row justify-between px-2 ">
        <div
          className=" flex items-center flex-wrap justify-center hover:cursor-pointer"
          onClick={handleUploadImageBtn}
        >
          <svg
          ...
          <span className="hover:cursor-pointer" onClick={handleUploadImageBtn}>
            Image
          </span>
        </div>
        ...
        <div className="flex items-center flex-wrap justify-center">
          <button className=" bg-primary dark:bg-dark-primary w-22 px-4 py-2 rounded-md">
            POST
          </button>
        </div>
      </div>
