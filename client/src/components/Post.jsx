    ...
    <div className="w-full bg-background dark:bg-dark-background text-inherit shadow-xl rounded-xl my-4 py-4 px-2">
      ...
      <div className="flex justify-between w-full">
        <Profileinfo
          ...
          text={location}
          personId={personId}
          addOrRemoveFriends={personId !== user._id ? addOrRemoveFriends : null}
        />
        {/* add friends button */}
        {personId === user._id ? (
          <button
            onClick={handleDeletePost}
            className="h-8 w-8 bg-secondary dark:bg-dark-secondary flex items-center justify-center rounded-full"
          >
            <svg
          ...
          <div className="flex gap-5 items-center justify-evenly">
            ...
            <div className="intraction-item" onClick={handleOnClickComment}>
              <svg
                ...
                className="fill-text dark:fill-dark-text"
              >
                <path d="M270-400h420q12.75 0 21.375-8.675 8.625-8.676 8.625-21.5 0-12.825-8.625-21.325T690-460H270q-12.75 0-21.375 8.675-8.625 8.676-8.625 21.5 0 12.825 8.625 21.325T270-400Zm0-130h420q12.75 0 21.375-8.675 8.625-8.676 8.625-21.5 0-12.825-8.625-21.325T690-590H270q-12.75 0-21.375 8.675-8.625 8.676-8.625 21.5 0 12.825 8.625 21.325T270-530Zm0-130h420q12.75 0 21.375-8.675 8.625-8.676 8.625-21.5 0-12.825-8.625-21.325T690-720H270q-12.75 0-21.375 8.675-8.625 8.676-8.625 21.5 0 12.825 8.625 21.325T270-660ZM140-240q-24 0-42-18t-18-42v-520q0-24 18-42t42-18h680q24 0 42 18t18 42v668q0 19.688-18.5 27.344Q843-117 829-131L720-240H140Zm0-60h680v-520H140v520Zm0 0v-520 520Z" />
              </svg>
            </div>
          </div>
        ...
        {commentSection.isClick && (
          <div className="mt-4  px-3">
            <form onSubmit={handleCommentSubmite} className="flex gap-2 my-4">
              <input
                className="w-full px-2 bg-inherit text-inherit border rounded-md"
                type="text"
                onChange={handleOnChange}
                value={commentSection.comment}
              />
              <button
                className=" bg-primary dark:bg-dark-primary rounded-lg px-2 py-1"
                type="submit"
              >
                {" "}
                comment
            ...
            <div className="comments">
              {comments.map((comment, index) => {
                return (
                  <p className="font-body text-base leading-7" key={index}>
                    {comment}
                  </p>
                );
              })}
