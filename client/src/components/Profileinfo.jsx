  ...
  return (
    <div className="w-full flex justify-between items-center">
      <div className="flex gap-3 items-center">
        ...
        <div>
          <h3 className=" font-heading text-lg" onClick={goToUserProfile}>
            {name}
          </h3>
      ...
      <div>
        {addOrRemoveFriends && (
          <button
            ...
            className="w-10 h-10 bg-primary dark:bg-dark-primary flex items-center justify-center rounded-full"
          >
            <svg
